...
public class SeleniumPowVideo {
    public static void main(String[] args) {
        ...
        // Abrir la URL
        driver.get("https://powstreem.info/63leiifk25zw");
        ...
        try {
            ...
            // Ahora sí, esperar a que el botón "Continuar al video" sea visible y clickeable
            ...
            System.out.println("✅ Click en 'Continuar al video'");
            ...
            WebElement videoElement = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("div.jw-media.jw-reset video[jw-loaded='data']")));
